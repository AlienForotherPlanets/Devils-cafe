...
export default function Order_list({navigation}){
    ...
    useEffect(() => {
        ...
        const Fetch_pending_order_request = async () => {
            ...
            let Request_data = {
                "Check_status":"Fetch-pending-order", 
    ...
    const Complete_order_handler = async () => {
        ...
        try{
            ...
            let Request_data = {
                "Check_status":"Fetch-complete-order", 
                "Table_name": User_table
            } ; 
                            ...
                            {order_data.map((element, index) => {
                                ...
                                return(
                                    ...
                                    <View style={OrderlistStyle.OrderInformationLayout} 
                                        ...
                                        {element.Product_data.map((element, index) => {
                                                ...
                                                <View style={OrderlistStyle.CakeInformationLayout}
                                                    ...
                                                    <Pressable>
                                                        ...
                                                        <Image
                                                            ...
                                                            source={{uri:element.Product_image}}
                                                        />
                                                    ...
                                                    <View style={OrderlistStyle.ProductInformation}>
                                                        ...
                                                        <View style={OrderlistStyle.ProductPrice}>
                                                            ...
                                                            <TextComponent
                                                                TextValue = {element.Product_weight}
                                                                TextColor = {colorCode.Authentication_title_color}
                                                                TextSize = {16}
                                                                TextFamily = "Ubuntu"
                                                        ...
                                                        <View style={OrderlistStyle.ProductPrice}>
                                                            ...
                                                            <TextComponent
                                                                TextValue = {element.Product_on_name}
                                                                TextColor = {colorCode.Authentication_title_color}
                                                                TextSize = {16}
                                                                TextFamily = "Ubuntu"
                                                                TextStyle = {{marginLeft: 10, 
