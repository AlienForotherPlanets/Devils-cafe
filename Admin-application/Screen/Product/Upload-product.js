...
export default function UploadProduct({navigation, route}){
    ...
    const [productDiscountBorder, setProductDiscountBorder] = useState(false) ; 
    ...
    const FocusHandler = (x) => {
        ...
        setProductDiscountBorder(false) ; 

        setFlavourBorder(false) ; 

        setBreadBorder(false) ; 

        setCreamBorder(false) ; 
        ...
        if  (imageFile.length == 0 ){
            ...
            for (let i = 0 ; i<imageFile.length; i++){
                ...
                if ( i == 0 ){
                    ...
                    ImageFile1_data = TempData ; 
                      
                }else if ( i == 1){

                    ImageFile2_data = TempData ; 

                }else{

                    ImageFile3_data = TempData ; 
            ...
            // ====== Upload cake image1 to Cloudinary ====== // 

            if (ImageFile1_data != null){
                ...
                try{
                    ...
                    ImageData.append('file', ImageFile1_data); 
                    ...
                    if (Upload_image_response != null){
                        ...
                        Image1_url  = await Upload_image_response.url ; 
                        ToastAndroid.show("Upload product image1 successfully", ToastAndroid.BOTTOM, ToastAndroid.SHORT) ;
                    }
                }catch{
                    
                    ToastAndroid.show("Failed to upload cake image1", ToastAndroid.BOTTOM, ToastAndroid.SHORT) ; 
                }
                
                
            } 

            // ====== Upload cake image2 to cloudinary ====== / /

            if (ImageFile2_data != null){
                
                try {

                    const ImageData = new FormData() ; 
                    ImageData.append('file', ImageFile2_data); 
                    ImageData.append('upload_preset', 'DevileCafe_product'); 
                    ImageData.append('cloud_name', 'dsc8egt36'); 
                    ...
                    if (Upload_image_response != null){
                        ...
                        Image2_url  = await Upload_image_response.url ; 
            ...
            // ====== Upload cake image3 to cloudinary ====== // 

            if (ImageFile3_data != null){
                
                try {

                    const ImageData = new FormData() ; 
                    ImageData.append('file', ImageFile3_data); 
                    ImageData.append('upload_preset', 'DevileCafe_product'); 
                    ImageData.append('cloud_name', 'dsc8egt36'); 
                    ...
                    if (Upload_image_response != null){
                        ...
                        Image3_url  = await Upload_image_response.url ; 
            ...
            let Request_data = {
                ...
                "Product_image1": Image1_url, 
                "Product_image2": Image2_url == ''?'None': Image2_url,
                "Product_image3": Image3_url == ''?'None': Image3_url,  
            ...
            <View style={UploadProductStyle.UploadProductScreen}>
                ...
                <ScrollView style={UploadProductStyle.UploadProduct_inputLayout}
                    ...
                    <TextInput
                        ...
                        placeholder = "Enter cake information"
                    ...
                    <TextInput
                        ...
                        placeholder = "Enter 500gm cake retail price"
                        placeholderTextColor= {colorCode.Authentication_subtitle_color}
                    ...
                    <TextInput
                        ...
                        placeholder = "Enter 500gm cake discount price"
                        placeholderTextColor= {colorCode.Authentication_subtitle_color}
                    ...
                    <TextComponent
                        ...
                        TextColor = "#3c3c3c"
                        TextSize = {17}
                        TextStyle = {{marginTop:8, marginBottom:8, textAlign:"center"}}
                    />
